...
class TestTsd < Test::Unit::TestCase
  ...
  def test_tmda_ci
    ...
    f = ["sum",1]
    theta=[[0,0]]
    result = [[1, 1, 5, 1500], [1, 6, 10, 1500], [1, 11, 12, 520], [2, 4, 10, 1200], [1, 13, 15, 930], [1, 16, 18, 150], [1, 19, 21, 750], [1, 22, 24, 150], [2, 13, 18, 900]]
    assert_equal(result, tmda_ci(g,r,f,theta,"m"))
    result = [[1, 1, 5, 3300], [1, 6, 10, 3800], [1, 11, 12, 3400], [2, 4, 10, 1200], [1, 13, 15, 4000], [1, 16, 18, 600], [1, 19, 21, 1200], [1, 22, 24, 600], [2, 13, 18, 900]]
    assert_equal(result, tmda_ci(g,r,f,theta,"c"))
  end
end